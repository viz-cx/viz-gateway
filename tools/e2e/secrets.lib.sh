...
E2E_VARS=(
  ...
  E2E_GRAM_ENDPOINT
  E2E_GRAM_API_KEY
  E2E_GRAM_GATEWAY_JETTON_WALLET
  E2E_GRAM_GATEWAY_OWNER
  E2E_GRAM_JETTON_MINTER_ADDRESS
  E2E_GRAM_MULTISIG_ADDRESS
  E2E_GRAM_SIGNER_MNEMONIC
  E2E_GRAM_BURN_MNEMONIC
  E2E_GRAM_BURN_OWNER
  E2E_GRAM_MIN_GAS_NANO
)
